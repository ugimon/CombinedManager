<?php /* Template_ 2.2.3 2014/01/07 17:55:06 D:\www\vhost.manager\_template\content\config\popup.add.html */?>
<script> 
function chk_form()
{
	...
	<form action="/config/popupProcess" method="post" enctype="multipart/form-data" name="FormData" onsubmit="return chk_form();">
		...
		<legend class="blind">팝업창 추가</legend>
			<tr>
				...
				<td>
					<select name="logo">
					<option value="totobang"  <?php if($TPL_VAR["logo"]=="totobang"){?>  selected <?php }?>>킹덤</option>
					<option value="orange" <?php if($TPL_VAR["logo"]=="orange"){?> selected <?php }?>>아레나 </option>
				</select>
				</td>
			 </tr>
			 <tr>
			<tr>
			 ...
			 <tr>
				<th>내용</th>
				<td><textarea name="P_CONTENT" style="height:100px;" maxlength="50"><?php echo $TPL_VAR["list"]["P_CONTENT"]?></textarea></td>
			  </tr>
			  <tr>
				<th>팝업 사용</th>
