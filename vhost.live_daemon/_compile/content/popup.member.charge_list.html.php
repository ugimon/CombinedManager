<?php /* Template_ 2.2.3 2012/10/09 18:29:36 C:\APM_Setup\htdocs\www\vhost.manager\_template\content\popup.member.charge_list.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
			<tr class="link_lan" style="padding-left:1px;"  onMouseOver="this.style.backgroundColor='#e0eafe';" onMouseOut="this.style.backgroundColor=''" >
				...
				<td><a href="javascript:open_window('/member/detail?idx=<?php echo $TPL_V1["idx"]?>',700,500)"><?php echo $TPL_V1["mem_id"]?></td>
