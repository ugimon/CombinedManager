<?php /* Template_ 2.2.3 2012/10/09 23:21:19 C:\APM_Setup\htdocs\www\vhost.manager\_template\content\popup.member.member_memo.html */
...
<div id="wrap_pop">
	...
	<ul id="tab">
		<li><a href="/member/memo?username=<?php echo $TPL_VAR["nname"]?>" id="members_rmemo">받은쪽지함</a></li>
		<li><a href="/member/sendmemolist?username=<?php echo $TPL_VAR["nname"]?>" id="members_smemo">보낸쪽지함</a></li>
	</ul>
...
<?php }?>	
					...
					<td width="20%">
						<a href="javascript:open_window('memo_Reply.php?idx=<?php echo $TPL_V1["mem_idx"]?>&fromid=<?php echo $TPL_V1["fromid"]?>',650,300)"><img src="/img/btn_s_answer.gif" title="답변"></a>&nbsp;
						<a href="javascript:confirm('정말 삭제하시겠습니까?');location.href='memo_list.php?act=onedel&idx=<?php echo $TPL_V1["mem_idx"]?>';"><img src="/img/btn_s_del.gif" title="삭제"></a>
					</td>
				</tr>
			</tbody>
		</table>
