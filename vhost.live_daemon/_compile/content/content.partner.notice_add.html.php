<?php /* Template_ 2.2.3 2012/10/08 21:51:15 C:\APM_Setup\htdocs\www\vhost.manager\_template\content\content.partner.notice_add.html */?>
<script>
...
<div class="wrap" id="partner_notice_add">
	...
	<ul id="tab">
		<li><a href="partner/notice_list" id="partner_notice">파트너 공지</a></li>
		<li><a href="partner/notice_add" id="partner_notice_add">공지 쓰기</a></li>
	</ul>
	...
	<legend class="blind">공지 쓰기</legend>
		...
		<tr>
			<th>시간</th>
			<td><input name="time" type="text" class="w120" value="<?=date("Y-m-d H:i:s")?>"/>&nbsp;&nbsp;&nbsp;<font color="red">날자는 꼭 지정된 형식대로 적어주십시오.</font></td>
		</tr>
		<tr>
			<th>내용</th>
