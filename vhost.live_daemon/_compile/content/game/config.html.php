<?php /* Template_ 2.2.3 2012/11/01 13:19:59 D:\www\vhost.manager\_template\content\game\config.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
				<tr>
					...
					<td>
						<a href="/game/betlist?intParentIdx=<?php echo $TPL_V1["intParentIdx"]?>">[베팅현황보기]</a><br>
...
<?php }?>
					...
					<td>
<?php if($TPL_V1["blnGameEnd"]=="Y"){?>
							종료
<?php }else{?>
							<font color='red'>진행중</font>
<?php }?>
					</td>
					<td><a href="/game/gamelist?intParentIdx=<?php echo $TPL_V1["intParentIdx"]?>" class="btnStyle4">항목보기</a></td>
