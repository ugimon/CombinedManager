<?php /* Template_ 2.2.3 2013/11/19 11:34:48 D:\www_kd\vhost.manager\_template\content\gameUpload\game_copy_list.html */
...
<?php }}?>
		...
		<div class="wrap_search">	
			...
			스페셜 핸디캡 : <input type="text" name="special_handicap_rate" size="5" value="1.86" style="border:1px #97ADCE solid;" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")'>
			스페셜 언더오버 : <input type="text" name="special_underover_rate" size="5" value="1.86" style="border:1px #97ADCE solid;" onkeyup='this.value=this.value.replace(/[^0-9.]/gi,"")'>
			<br>
