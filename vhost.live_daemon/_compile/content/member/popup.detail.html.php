<?php /* Template_ 2.2.3 2013/09/29 20:22:48 D:\www\vhost.live_daemon\_template\content\member\popup.detail.html */
...
<?php if(strpos($TPL_VAR["quanxian"],"1001")>=0&&$TPL_VAR["list"]["mem_status"]!='G'){?>
			  			<a href="javascript:open_window('/member/popup_moneychange?idx=<?php echo $TPL_VAR["list"]["sn"]?>&act=money',400,250)"> <?php echo number_format($TPL_VAR["list"]["g_money"],0)?> </a>
<?php }else{?>
...
<?php }}?>
			...
			<tr>
			  ...
			  <td>
			  	<!--
			  		<select>
<?php if(sizeof($TPL_VAR["joiners"])>0){?>
