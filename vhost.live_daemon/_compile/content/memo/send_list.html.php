<?php /* Template_ 2.2.3 2013/01/22 23:42:04 D:\www\vhost.live_daemon\_template\content\memo\send_list.html */
		...
		<table cellspacing="1" class="tableStyle_normal" summary="보낸 쪽지함">
			...
			<tbody>
				<tr onClick="javascript:ShowFLT(<?php echo $TPL_V1["mem_idx"]?>)">
					...
					<td width="10%"><?php echo $TPL_V1["toid"]?></td>
					<td width="10%"><?php echo $TPL_V1["nick"]?></td>
					<td width="10%"><?php echo $TPL_V1["bank_member"]?></td>
					<td width="10%"><?php echo $TPL_V1["fromid"]?></td>
					<td width="30%"><span class="subject"><?php echo mb_strimwidth($TPL_V1["title"],0,36,"..","utf-8")?></span></td>
...
<?php }?>					
					...
					<!--
					<td width="20%"><a href="javascript:confirm('정말 삭제하시겠습니까?');location.href='/memo/sendlist?act=onedel&idx=<?php echo $TPL_V1["mem_idx"]?>';"><img src="/img/btn_s_del.gif" title="삭제"></a></td>
					-->
				</tr>
			</tbody>
			
			<table id="LM_<?php echo $TPL_V1["mem_idx"]?>" style="display:none" class="memo_answer" value='aa'>
				<tr class="line">
					<th valign="top">제목 :</th>
