<?php /* Template_ 2.2.3 2012/10/10 12:21:04 C:\APM_Setup\htdocs\www\vhost.manager\_template\content\content.partner.join_list.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
		<tr>
			...
			<td><a href="javascript:void(0);" onclick="go_delete('partner_reg.php?act=delone&idx=<?php echo $TPL_V1["Idx"]?>');return false;"><img src="/img/btn_s_del.gif" title="삭제"></a>&nbsp;<a href="javascript:void(0)" onclick="go_add('partner_reg.php?act=add&idx=<?php echo $TPL_V1["Idx"]?>');return false"><img src="/img/btn_s_confirm2.gif" title="승인"></a></td>
		</tr>
<?php }}?>
	</tbody>
	</table>
