<?php /* Template_ 2.2.3 2014/06/13 19:42:48 D:\www\vhost.manager\_template\content\partner\list.html */
...
$TPL_item_2=empty($TPL_V1["item"])||!is_array($TPL_V1["item"])?0:count($TPL_V1["item"]);?>
			<tr>
				<td><?php if($TPL_V1["logo"]=='totobang'){?>킹덤<?php }elseif($TPL_V1["logo"]=='orange'){?>미니<?php }?></td>
