<?php /* Template_ 2.2.3 2014/09/05 18:28:28 D:\www\vhost.manager\_template\content\stat\bet.html */
		...
		<div>
			<form action="?" method="GET" name="form2" id="form2">
				...
				<select name="filter_logo">
					...
					<option value="orange" <?php if($TPL_VAR["filter_logo"]=="orange"){?> selected <?php }?>>미니</option>
				</select>
				&nbsp;&nbsp;&nbsp;&nbsp;
