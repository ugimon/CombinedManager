<?php /* Template_ 2.2.3 2012/10/06 17:54:06 C:\APM_Setup\htdocs\www\vhost.manager\_template\content\content.member.login_list.html */
...
<?php }?>
				...
				<td><a href="javascript:void(0)" onclick="comfire_ok(<?php echo $TPL_V1["idx"]?>,'user_loginlist.php?act=deleteone&idx=')"><img src="/img/btn_s_del.gif" title="삭제"></a></td>
			</tr>  
<?php }}?>
	</tbody>
	</table>
