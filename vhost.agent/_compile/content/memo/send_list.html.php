<?php /* Template_ 2.2.3 2014/06/29 01:05:46 D:\www\vhost.manager\_template\content\memo\send_list.html */
		...
		<table cellspacing="1" class="tableStyle_normal" summary="보낸 쪽지함">
			...
			<tbody>
				<tr onClick="javascript:ShowFLT(<?php echo $TPL_V1["mem_idx"]?>)">
					...
					<td width="5%"><?php if($TPL_V1["logo"]=="totobang"){?>킹덤<?php }else{?>미니<?php }?></td>
