...
KE.util = {
	...
	getpic : function(id) {
	  ...
	  var data2="";
	  var data3="";
	  var rep=new RegExp("kesrc\=.+?\.(gif|jpg|jpeg|jpe|png)","gim")
	  data = data.match(rep);
	   //alert(data);
	   if(data!=null)
	   {
...
KE.lang = {
	...
	bold : '굵음(Ctrl+B)',
	italic : '사선(Ctrl+I)',
	underline : 'underline(Ctrl+U)',//下划线
	strikethrough : 'strikethrough',//删除线
	removeformat : 'removeformat',//删除格式
	image : '이미지',
	flash : 'Flash삽입',
	media : '미디어 삽입',
	table : '테이블 삽입',
	...
	tableinsert : '테이블 삽입',
	tabledelete : '테이블 삭제',
	tablecolinsertleft : 'tablecolinsertleft',//左侧插入列
	tablecolinsertright : 'tablecolinsertright',//右侧插入列
	tablerowinsertabove : 'tablerowinsertabove',//上方插入行
	tablerowinsertbelow : 'tablerowinsertbelow',//下方插入行
	tablecoldelete : '열삭제',
	tablerowdelete : '행삭제',
	noColor : '무색상',
	invalidImg : "유효한 URL격식을 입력하여 주십시오.\n jpg,gif,bmp,png 파일만 가능합니다.",
	invalidMedia : "유효한 URL격식을 입력하여 주십시오.\n swf,flv,mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb 파일만 가능합니다.",
	invalidWidth : "width는 수자만 가능합니다.",
	invalidHeight : "height는 수자만 가능합니다.",
	invalidBorder : "Border은 수자만 가능합니다.",
	invalidUrl : "유효한 URL 주소를 입력 하십시오.",
	invalidRows : '행수는 필수입력항 입니다. 0보다큰 수자만 입력 가능합니다.',
	invalidCols : '열수는 필수입력항 입니다. 0보다큰 수자만 입력 가능합니다.',
	invalidPadding : 'Padding은 수자만 가능합니다.',
	invalidSpacing : 'Spacing은 수자만 가능합니다.',
	invalidBorder : 'Border은 수자만 가능합니다.',
	pleaseInput : "내용을 입력하십시오.",
	invalidJson : '예치못한 오류가 발생하였습니다.',
	cutError : '사용하시는 브라우저 안전설정에 cut 기능 사용제한이 되여있습니다. (Ctrl+X)로 사용하여주십시오.',
	copyError : '사용하시는 브라우저 안전설정에 copy 기능 사용제한이 되여있습니다. (Ctrl+C)로 사용하여주십시오.',
	pasteError : '사용하시는 브라우저 안전설정에 paste 기능 사용제한이 되여있습니다. (Ctrl+V)로 사용하여주십시오.'
};
...
plugins.about = {
	version : KE.version,
	title : 'HTML 문장편집기 -  1.0'
};

plugins.plainpaste = {
	comment : '(Ctrl+V)로 내용물을  붙여주세요.'
};
...
plugins.file_manager = {
	emptyFolder : 'emptyFolder',//空文件夹
	moveup : 'moveup',//移到上一级文件夹
	viewType : '출력방식:',//显示方式：
	viewImage : '미리보기',
	listImage : '상세정보',
	orderType : '배열 방식',
