<?php /* Template_ 2.2.3 2016/06/12 03:08:58 C:\inetpub\combined_manager\vhost.manager\_template\content\partner\list.html */
$TPL_logo_list_1=empty($TPL_VAR["logo_list"])||!is_array($TPL_VAR["logo_list"])?0:count($TPL_VAR["logo_list"]);
...
<?php if($TPL_logo_list_1){foreach($TPL_VAR["logo_list"] as $TPL_V1){?>
...
$TPL_logo_list_2=empty($TPL_V1["logo_list"])||!is_array($TPL_V1["logo_list"])?0:count($TPL_V1["logo_list"]);
$TPL_item_2=empty($TPL_V1["item"])||!is_array($TPL_V1["item"])?0:count($TPL_V1["item"]);?>
			<tr>
				<td>
<?php if($TPL_logo_list_2){foreach($TPL_V1["logo_list"] as $TPL_V2){?>
<?php if($TPL_V1["logo"]==$TPL_V2["name"]){?><?php echo $TPL_V2["nick"]?><?php }?>
<?php }}?>
				</td>
				...
				<td><?php echo $TPL_V1["child_member_count"]?></td>
				<td><?php echo number_format($TPL_V1["child_rec_account"],0)?></td>
				<td><?php echo number_format($TPL_V1["child_rec_nc_account"],0)?></td>
...
<?php }?>
				...
				<td><?php echo number_format($TPL_V1["child_rec_wb_account"],0)?></td>
				<td><?php echo number_format($TPL_V1["child_rec_sb_account"],0)?></td>
