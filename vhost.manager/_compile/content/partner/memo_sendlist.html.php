<?php /* Template_ 2.2.3 2016/03/07 11:27:12 C:\inetpub\web\5. Armand De\www\vhost.manager\_template\content\partner\memo_sendlist.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>	
			<tr>
				<td><input name="y_id[]" type="checkbox" id="y_id" value="<?php echo $TPL_V1["mem_idx"]?>"  onclick="javascript:chkRow(this);"/></td>
				...
				<td><a href="javascript:void(0);" onclick="go_del('?act=del&id=<?php echo $TPL_V1["mem_idx"]?>');"><img src="/img/btn_s_del.gif" title="삭제"></a></td>   
				</tr>
