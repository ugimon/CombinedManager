<?php /* Template_ 2.2.3 2016/04/28 04:49:08 C:\inetpub\combined_manager\vhost.manager\_template\content\log\mileage_list.html */
...
<?php }}?>
				...
				<select name="filter_state">
					...
					<option value="1" <?php if($TPL_VAR["filter_state"]==1){?> selected <?php }?>>첫충전</option>
					<option value="1" <?php if($TPL_VAR["filter_state"]==400){?> selected <?php }?>>매충전</option>
