<?php /* Template_ 2.2.3 2012/10/09 23:19:15 C:\APM_Setup\htdocs\www\vhost.manager\_template\content\popup.member.memo_send_list.html */
...
<div id="wrap_pop">
	...
	<ul id="tab">
		<li><a href="/popmember/memo?username=<?php echo $TPL_VAR["nname"]?>" id="members_rmemo">받은쪽지함</a></li>
		<li><a href="/popmember/sendmemolist?username=<?php echo $TPL_VAR["nname"]?>" id="members_smemo">보낸쪽지함</a></li>
	</ul>
