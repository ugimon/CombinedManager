<?php /* Template_ 2.2.3 2016/06/23 05:55:07 C:\inetpub\combined_manager\vhost.manager\_template\content\memo\popup.admin_write.html */
...
<div id="wrap_pop">
	...
	<legend class="blind">쪽지 쓰기</legend>
		...
		<tr>
		  <th>패스워드</th>
		  <td><input type=text name="password" maxlength="17" value="" /></td>
		</tr>
		<tr>
		  <th>받는이</th>
		  <td>
