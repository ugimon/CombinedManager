<?php /* Template_ 2.2.3 2016/06/28 05:48:26 C:\inetpub\combined_manager\vhost.manager\_template\content\memo\send_list.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
		<table cellspacing="1" class="tableStyle_normal" summary="보낸 쪽지함">
            ...
            <font color="<?php echo $TPL_V1["logo_color"]?>"><?php echo $TPL_V1["logo_nick"]?></font>
					...
					<td width="30%"><?php echo mb_strimwidth($TPL_V1["title"],0,50,"..","utf-8")?></td>
					<td width="10%"><?php echo $TPL_V1["writeday"]?></td>
					<td width="5%">
...
<?php if($TPL_V1["isdelete"]=='1'){?><font color="blue">삭제</font><?php }?>
			...
			<table id="LM_<?php echo $TPL_V1["mem_idx"]?>" style="display:none" class="memo_answer" value='aa'>
				<tr class="line">
					<th valign="top">제목 :</th>
					<td><?php echo mb_strimwidth($TPL_V1["title"],0,50,"..","utf-8")?></td>
				</tr>
				<tr>
					<th valign="top">내용 :</th>
