<?php /* Template_ 2.2.3 2012/10/10 01:28:02 C:\APM_Setup\htdocs\www\vhost.manager\_template\content\content.exchange.list.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
		<tr>
			...
			<td>
				<a href="javascript:open_window('Withdrawal_money.php?mode=del&idx=<?php echo $TPL_V1["idx"]?>&rmoney=<?php echo $TPL_V1["amount"]?>&money_idx=<?php echo $TPL_V1["money_idx"]?>',400,250)">
					<img src="/img/btn_s_cancel.gif" title="취소">
				</a>&nbsp;
				<a href="javascript:open_window('Withdrawal_money.php?idx=<?php echo $TPL_V1["idx"]?>&rmoney=<?php echo $TPL_V1["amount"]?>&money_idx=<?php echo $TPL_V1["money_idx"]?>',400,250)">
<?php if($TPL_V1["result"]==0){?><font color='red'>신청</font><?php }elseif($TPL_V1["result"]==1){?><font color='blue'>완료</font><?php }else{?><font color='yellow'>삭제</font><?php }?>
				</a>
			</td>
		</tr>
<?php }}?>
