<?php /* Template_ 2.2.3 2016/06/22 04:13:31 C:\inetpub\combined_manager\vhost.manager\_template\content\exchange\fin_list_edit.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
		<tr class="link_lan" style="padding-left:1px;"  onMouseOver="this.style.backgroundColor='#e0eafe';" onMouseOut="this.style.backgroundColor=''" >
			...
			<td  <?php if($TPL_V1["state"]=='0'){?>style="background-color:#FAF4C0"<?php }?>><?php echo number_format($TPL_V1["beforemoney"],0)?></td>
		...
		-->
			<td  <?php if($TPL_V1["state"]=='0'){?>style="background-color:#FAF4C0"<?php }?>><?php echo $TPL_V1["bank"]?></td>
			<td  <?php if($TPL_V1["state"]=='0'){?>style="background-color:#FAF4C0"<?php }?>>
				<a href="javascript:open_window('/member/rollingView?idx=<?php echo $TPL_V1["member_sn"]?>',800,550)">
						<img src="/img/btn_s_memo.gif" title="확인">
				</a>
			</td>
