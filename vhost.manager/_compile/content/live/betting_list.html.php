<?php /* Template_ 2.2.3 2016/04/23 11:04:08 C:\inetpub\combined_manager\vhost.manager\_template\content\live\betting_list.html */
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
			<tr id="t_<?php echo $TPL_V1["betting_no"]?>" class="gameGoing" >
				<td><?php if($TPL_V1["logo"]=='totobang'){?>포텐<?php }else{?>이클<?php }?></td>
