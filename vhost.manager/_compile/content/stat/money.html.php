<?php /* Template_ 2.2.3 2016/06/15 04:25:12 C:\inetpub\combined_manager\vhost.manager\_template\content\stat\money.html */
		...
		<div>
			<form action="?" method="GET" name="form2" id="form2">
				<span class="icon2">사이트</span>
					<input type="hidden" 	 name="filter_logo" id="filter_logo" value="<?php echo $TPL_VAR["filter_logo"]?>">
					<input type="checkbox" name="filter_site_logo" value="" <?php if($TPL_VAR["filter_logo"]==""){?> checked <?php }?> />전체
<?php if($TPL_logolist_1){$TPL_I1=-1;foreach($TPL_VAR["logolist"] as $TPL_V1){$TPL_I1++;?>
					<input type="checkbox" name="filter_site_logo" value=<?php echo $TPL_V1["name"]?> <?php if(substr($TPL_VAR["filter_logo"],$TPL_I1+1,1)=='1'){?> checked <?php }?> onClick="onLogoClick();" class="radio"/><?php echo $TPL_V1["nick"]?>
