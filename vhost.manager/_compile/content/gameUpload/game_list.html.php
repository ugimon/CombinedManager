<?php /* Template_ 2.2.3 2016/06/27 06:58:21 C:\inetpub\combined_manager\vhost.manager\_template\content\gameUpload\game_list.html */
...
<?php }?>
						...
						<td>
							<input type='button' class='btnStyle4' value="배당수정" onclick=open_window('/gameUpload/modifyrate?idx=<?php echo $TPL_V1["child_sn"]?>&gametype=<?php echo $TPL_V1["type"]?>&mode=edit','650','350')>
						</td>
						<td>
