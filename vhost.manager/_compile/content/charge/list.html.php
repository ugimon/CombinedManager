		...
		<div class="wrap">
			<form action="?" method="GET" name="form2" id="form2">
				...
				<select name="filter_logo">
					...
					<option value="eclipse" <?php if($TPL_VAR["filter_logo"]=="eclipse"){?> selected <?php }?>>아레나 </option>
				</select>
...
<?php if($TPL_list_1){foreach($TPL_VAR["list"] as $TPL_V1){?>
		<tr class="link_lan" style="padding-left:1px;"  onMouseOver="this.style.backgroundColor='#e0eafe';" onMouseOut="this.style.backgroundColor=''">
			...
			<td><?php if($TPL_V1["logo"]=='totobang'){?>킹덤<?php }elseif($TPL_V1["logo"]=='eclipse'){?>아레나<?php }?></td>
