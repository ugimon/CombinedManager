<?php /* Template_ 2.2.3 2016/06/27 07:08:15 C:\inetpub\combined_manager\vhost.manager\_template\content\game\betting_list.html */
...
<?php if($TPL_VAR["type"]=="ladder"){?>
		...
		<li><a href="/game/betlist?type=daridari">다리다리</a></li>
		<li><a href="/game/betlist?type=powerball">파워볼</a></li>
		<li><a href="/game/betlist?type=snail_race">달팽이</a></li>
<?php }elseif($TPL_VAR["type"]=="daridari"){?>
		<li><a href="/game/betlist">일반</a></li>
		<li><a href="/game/betlist?type=ladder">사다리</a></li>
		<li class="on"><a href="/game/betlist?type=daridari">다리다리</a></li>
		<li><a href="/game/betlist?type=powerball">파워볼</a></li>
		<li><a href="/game/betlist?type=snail_race">달팽이</a></li>
<?php }elseif($TPL_VAR["type"]=="powerball"){?>
		...
		<li><a href="/game/betlist?type=snail_race">달팽이</a></li>
<?php }elseif($TPL_VAR["type"]=="snail_race"){?>
		<li><a href="/game/betlist">일반</a></li>
		<li><a href="/game/betlist?type=ladder">사다리</a></li>
		<li><a href="/game/betlist?type=daridari">다리다리</a></li>
		<li><a href="/game/betlist?type=powerball">파워볼</a></li>
		<li class="on"><a href="/game/betlist?type=snail_race">달팽이</a></li>
<?php }else{?>
