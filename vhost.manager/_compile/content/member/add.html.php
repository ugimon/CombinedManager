<?php /* Template_ 2.2.3 2016/04/28 10:28:41 C:\inetpub\web\5. Armand De\www\vhost.manager\_template\content\member\add.html */?>
<script>
	function checknull()
	{
...
<div class="wrap" id="members">
	...
	<form id="form1" name="form1" method="post" action="?">
		...
		<tr>
		  ...
		  <td colspan='3'>
		  	<select name="logo">
					<option value="totobang" selected>포텐</option>
