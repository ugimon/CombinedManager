<?php /* Template_ 2.2.3 2016/06/28 05:41:36 C:\inetpub\combined_manager\vhost.manager\_template\content\board\list.html */
...
<div class="wrap" id="board_<?php echo $TPL_VAR["province"]?>">
	...
	<ul id="tab">
		...
		<!--<li><a href="/board/list?province=10" id="analyze">분석&유머게시판</a></li>-->
...
<?php }}?>
				...
				<!-- 키워드 검색 -->
				<select name="field">
<?php if($TPL_VAR["province"]!=2&&$TPL_VAR["province"]!=7&&$TPL_VAR["province"]!=10){?>
